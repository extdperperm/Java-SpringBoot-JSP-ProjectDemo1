...
<head>
<meta charset="UTF-8">
<title>Spring Proyect Demo 1 - Ejemplo 3</title>
...
<body>
    ...
    <div class="cuerpo">
        <div class="panel2">
            ...
            -->
            <div class="item"><p><span>Resultado Ejemplo 3:</span> Se ha recibido por parámetro por método POST; Ciclo = ${param.Ciclo}, Grupo = ${param.Grupo} y Turno = ${param.Turno}. Ejecutado Correctamente.</p></div>

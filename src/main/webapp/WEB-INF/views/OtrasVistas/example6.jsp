...
<head>
<meta charset="UTF-8">
<title>Spring Proyect Demo 1 - Ejemplo 6</title>
...
<body>
    ...
    <div class="cuerpo">
        <div class="panel2">
            ...
            -->
            <div class="item"><p><span>Resultado Ejemplo 6:</span> El resultado de sumar 5 a ${param.numero} es ${Resultado}.  Ejecutado Correctamente.</p></div>

...
<head>
<meta charset="UTF-8">
<title>Spring Proyect Demo 1 - Ejemplo 10</title>
...
<body>
    ...
    <div class="cuerpo">
        <div class="panel2">
            ...
            <!-- A la hora de acceder al objeto del negocio bajo el parámetro de DataProfesor, fijarse en como se puede acceder escribiendo los métodos geters sin la palabra "get" y sin los paréntesis empezando en minuscula.
                 También se puede especificar el nombre completo del método get incluido los paréntesis (ej: Edad).
             -->
            <div class="item"><p><span>Resultado Ejemplo 10:</span> A continuación se muestran los datos del profesor. Ejecutado Correctamente.</p></div>
            <div class="item"><p><b>Nombre:</b> ${DataProfesor.nom}</p>
                              <p><b>Apellidos:</b> ${DataProfesor.apell}</p>
                              <p><b>Edad:</b> ${DataProfesor.edad}</p>
            </div>

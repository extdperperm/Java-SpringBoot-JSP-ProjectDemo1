...
<head>
<meta charset="UTF-8">
<title>Spring Proyect Demo 1 - Ejemplo 8</title>
    ...
    <div class="cuerpo">
        <div class="panel2">
            ...
            <!-- A la hora de acceder al objeto del negocio bajo el parámetro de AlumnoData, fijarse en como se puede acceder escribiendo los métodos geters sin la palabra "get" y sin los paréntesis empezando en minuscula.
             ...
             -->
            <div class="item"><p><span>Resultado Ejemplo 8:</span> A continuación se muestran los datos del alumno.  Ejecutado Correctamente.</p></div>

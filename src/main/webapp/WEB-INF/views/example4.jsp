...
<head>
<meta charset="UTF-8">
<title>Spring Proyect Demo 1 - Ejemplo 4</title>
...
<body>
    ...
    <div class="cuerpo">
        <div class="panel2">
            <div class="item"><p><span>Resultado Ejemplo 4:</span> Ejecutado Correctamente.</p></div>
            <div class="item"><p style="text-align:center;"><a href="../index">Volver</a></p></div>
        </div>
    </div>
